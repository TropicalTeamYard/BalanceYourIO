...
object BillRecordsProvider {
    ...
    fun getBillRecordsForSumByTimeMode(billRecords: ArrayList<BillRecord>, timeMode: TimeMode): ArrayList<HashMap<IOType, Double>>{
    ...
    fun getBillRecordsForTimeListByTimeMode(billRecords: ArrayList<BillRecord>, timeMode: TimeMode): ArrayList<Date>{
        val timeModeBill=ArrayList<ArrayList<BillRecord>>()
        val timeModeSum=ArrayList<HashMap<IOType, Double>>()
        val timeModeList: ArrayList<Date>
